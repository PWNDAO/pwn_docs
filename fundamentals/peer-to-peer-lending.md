...
{% hint style="info" %}
In the lending pool model, lenders pool their assets into a pool. Then, anyone can deposit approved collateral (usually approved by a DAO). Borrowers can then borrow against their deposited collateral.
{% endhint %}
